...
const String vida = 'assets/images/vida.png';
const String Logo = 'assets/images/Logo.png';
const String rayo = 'assets/images/rayo.png';
...
class AttributePainter extends CustomPainter {
  ...
  })  : bgPaint = Paint()..color = const Color.fromARGB(255, 255, 255, 255).withOpacity(0.25),
        strokeBgPaint = Paint()..color = const Color.fromARGB(255, 255, 255, 255), //olor de los botones de atributos
